(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-anything-sortable"] = factory(require("react/addons"));
	else
		root["react-anything-sortable"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortableItemMixin = __webpack_require__(3);

	var _SortableItemMixin2 = _interopRequireDefault(_SortableItemMixin);

	if (!_reactAddons2['default'].addons) {
	 ...
	 * @class Sortable
	 */
	var Sortable = _reactAddons2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    this.containerWidth = _reactAddons2['default'].findDOMNode(this).offsetWidth;
	  },
